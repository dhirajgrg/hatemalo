...
class SendEmail {
  ...
  async sendWelcome() {
    await this.send(
      "Welcome to Hatemalo",
      "We're excited to have you on board! Explore listings, post ads, and connect with buyers and sellers across Nepal.",
      "Visit Dashboard",
    );
  }
  ...
  async sendVerification() {
    await this.send(
      "Hatemalo — Verify your email",
      "Welcome to Hatemalo! Please verify your email address to get started.",
      "Verify Email",
    );
  }
